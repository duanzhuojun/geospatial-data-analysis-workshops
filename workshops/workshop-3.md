...
<nav style="background-color: #f4f4f4; padding: 1rem; margin-bottom: 2rem; border-radius: 5px;">
  ...
  <a href="{{ site.baseurl }}/workshops/workshop-2.html" style="margin-left: 10px; text-decoration: none;">Workshop 2</a>
  <a href="{{ site.baseurl }}/workshops/workshop-3.html" style="margin-left: 10px; text-decoration: none; font-weight: bold;">Workshop 3</a>
</nav>
